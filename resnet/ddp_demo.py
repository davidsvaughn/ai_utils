...
def train_model(rank, args):
    ...
    for epoch in range(args.n_epochs):
        ...
        if rank == 0:
            fps = int(args.world_size*total/(time.time()-t0))
            print("Epoch: {}, Loss: {}, Training Accuracy: {}, FPS: {}". format(epoch+1, loss.item(), accuracy/total, fps))
...
def run_train_model(train_func, world_size):
    ...
    parser.add_argument('--batch_size', type=int, default=196, help='size of the batches')
